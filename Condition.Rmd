...
(HSI_F_line<- ggplot(F_HSI_Summary, aes(y=HSI*100, x=Month, colour=Site)) + ylim(0, 6) + ylab("Hepatosomatic Index \n (Liver Weight/Total Weight * 100)") + labs(title = "Female") + geom_errorbar(aes(ymin=(HSI-se)*100, ymax=(HSI+se)*100), width=.1) + geom_point() + geom_line(aes(group=Site))+ theme_classic () + scale_colour_manual(values=c("black", "grey")) + theme(plot.margin = margin(t=0.5, l=0.5, r=0.5, b=0.5, unit = "cm"), text = element_text(size = 15), legend.position = "bottom"))
...
(GSI_M_line<- ggplot(M_GSI_Summary, aes(y=GSI*100, x=Month, colour=Site)) + ylim(0, 10) + geom_errorbar(aes(ymin=(GSI-se)*100, ymax=(GSI+se)*100), width=.1)+ labs(title = "Male") + geom_point() + geom_line(aes(group=Site))+ theme_classic () + scale_colour_manual(values=c("black", "grey")) + theme(plot.margin = margin(t=0.5, l=0.5, r=0.5, b=0.5, unit = "cm"), text = element_text(size = 15), legend.position = "bottom") + ylab("Gonadosomatic Index \n (Gonad Weight/Total Weight * 100)"))
...
```{r, echo=FALSE}
M_GSI<- ggplot(RG.M, aes(x=Month, y=GSI*100, fill=Site)) + geom_boxplot(position=position_dodge(1)) + labs(y=NULL, x = NULL, title = "Male", fill = "Site") + ylim(0, 20) + scale_fill_manual(values=c("black", "grey"                                                                                                                                                                                                )) +geom_hline(yintercept=1, linetype="dashed", size=1) + theme (axis.text.x = element_text( size = 12), axis.text.y = element_text( size = 12), axis.title.x = element_text(size = 15), axis.title.y = element_text( size = 13), legend.text = element_text(size=13), legend.title = element_text(size=15)) +theme_classic ()
M_GSI
```
...
(GSI_F_line<- ggplot(F_GSI_Summary, aes(y=GSI*100, x=Month, colour=Site)) + ylim(0, 10) + geom_errorbar(aes(ymin=(GSI-se)*100, ymax=(GSI+se)*100), width=.1) + labs(title = "Female") + geom_point() + geom_line(aes(group=Site))+ theme_classic () + scale_colour_manual(values=c("black", "grey")) + theme(plot.margin = margin(t=0.5, l=0.5, r=0.5, b=0.5, unit = "cm"), text = element_text(size = 15), legend.position = "bottom") + ylab("Gonadosomatic Index \n (Gonad Weight/Total Weight * 100)"))
...
(K_M_line<- ggplot(M_K_Summary, aes(y=K*100000, x=Month, colour=Site)) + ylim(1, 2) + geom_errorbar(aes(ymin=(K-se)*100000, ymax=(K+se)*100000), width=.1) + geom_point() + labs(title = "Male") + geom_line(aes(group=Site))+ theme_classic () + scale_colour_manual(values=c("black", "grey")) + theme(plot.margin = margin(t=0.5, l=0.5, r=0.5, b=0.5, unit = "cm"), text = element_text(size = 15), legend.position = "bottom") + labs(y=bquote("Fulton's Condition \n (Total Weight / Total" *Length^3~")*" * 10^5~")")))
...
(K_F_line<- ggplot(F_K_Summary, aes(y=K*100000, x=Month, colour=Site)) + ylim(1, 2) + geom_errorbar(aes(ymin=(K-se)*100000, ymax=(K+se)*100000), width=.1) + geom_point() + labs(title = "Female") + geom_line(aes(group=Site))+ theme_classic () + scale_colour_manual(values=c("black", "grey")) + theme(plot.margin = margin(t=0.5, l=0.5, r=0.5, b=0.5, unit = "cm"), text = element_text(size = 15), legend.position = "bottom") + labs(y=bquote("Fulton's Condition \n (Total Weight / Total" *Length^3~")*" * 10^5~")")))
