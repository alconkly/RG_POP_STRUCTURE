...
```{r, echo=FALSE}
glm_M <- glm(Maturity1~Total.Length,data=RG.M,family=binomial)
coef(glm_M)
...
```{r, echo=FALSE}
glm_F <- glm(Maturity1~Total.Length,data=RG.F,family=binomial)
coef(glm_F)
...
```{r, echo=FALSE}
glm_M_C <- glm(Maturity1~Total.Length,data=RG.M.C,family=binomial)
coef(glm_M_C)
...
```{r, echo=FALSE}
glm_M_R <- glm(Maturity1~Total.Length,data=RG.M.R,family=binomial)
coef(glm_M_R)
...
```{r, echo=FALSE}
glm_F_C <- glm(Maturity1~Total.Length,data=RG.F.C,family=binomial)
coef(glm_F_C)
...
```{r, echo=FALSE}
(glm_F_R <- glm(Maturity1~Total.Length,data=RG.F.R,family=binomial))
(coef(glm_F_R))
...
```{r}
(Maturity_length_plot<- ggplot(AllRG, aes(x=Total.Length, y=Maturity1, color=Site)) + geom_point(aes(color=Site)) + 
