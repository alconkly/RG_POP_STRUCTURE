...
(Site_Age_Maturity_table<- tbl_regression(glm_sites) %>% add_glance_table(
    include = c(nobs, logLik, AIC, BIC)) %>%  as_gt())
Site_Age_Maturity_table %>% gtsave(filename="Site_Age_Matuirty_table.png", path="G:/POP_STRUCTURE_PUB/Figures")
```
