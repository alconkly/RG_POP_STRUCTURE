...
Site_Length_Histogram<- ggarrange(Cobb_length_plot + rremove ("ylab") , Rose_length_plot + rremove ("ylab"),
                    ncol = 1, nrow = 2, common.legend = TRUE, legend="bottom")



(Length_Histogram<-ggplot(AllRG, aes(x=Total.Length, fill=Sex)) + geom_histogram(binwidth = 10, color="black") + labs(x = "Total Length (mm)",  y = "Count") + scale_fill_grey() + theme_classic ()+ scale_fill_grey() + theme_classic () + theme(plot.margin = margin(t=0.1, l=0.1, r=0.1, b=0.1, unit = "cm"), text = element_text(size = 12), legend.position = "bottom")+ ylim(0,250)+ xlim(0,250))

  ggsave("Length_Histogram.tiff", device="tiff", plot=Length_Histogram, path="C:/Users/ah2355/Documents/GitHub/RG_POP_STRUCTURE/Figures/TIFFs", dpi="retina", width = 3.3, height = 3)
```
